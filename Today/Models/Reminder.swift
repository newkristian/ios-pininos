...
//  Today
//
//  Created by christian soto hernandez on 19/07/24.
//
...
extension Reminder{
    static var sampleData = [
        Reminder(title: "Enviar reporte", dueDate: Date().addingTimeInterval(800.0), notes: "No olvidar recibos del taxi"),
        Reminder(title: "Revision de codigo", dueDate: Date().addingTimeInterval(14000.0),                 notes: "Verificar especificaciones en carpeta compartida",isComplete:true),
        Reminder(
